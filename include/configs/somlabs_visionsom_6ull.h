...
#define CFG_MFG_NAND_PARTITION "mtdparts=gpmi-nand:2m(boot),-(ubi) "
#else
#define CFG_MFG_NAND_PARTITION ""
#endif

#ifdef CONFIG_BOOTARGS_CMA
/* #define CONFIG_BOOTARGS_CMA_SIZE "" */
#define CFG_BOOTARGS_CMA_SIZE ""
#endif
...
#define CONFIG_MFG_ENV_SETTINGS \
	"mfgtool_args=setenv bootargs console=${console},${baudrate} " \
	    CFG_BOOTARGS_CMA_SIZE \
		"rdinit=/linuxrc " \
		"g_mass_storage.stall=0 g_mass_storage.removable=1 " \
		"g_mass_storage.file=/fat g_mass_storage.ro=1 " \
		"g_mass_storage.idVendor=0x066F g_mass_storage.idProduct=0x37FF "\
		"g_mass_storage.iSerialNumber=\"\" "\
		CFG_MFG_NAND_PARTITION \
		"clk_ignore_unused "\
		"\0" \
...
#define CFG_QSPI_BASE		QSPI0_BASE_ADDR
#define CFG_QSPI_MEMMAP_BASE		QSPI0_AMBA_BASE
