...
static void prepare_fcb(struct FCB* fcb, struct mtd_info *mtd, const char* timings)
{
    ...
    fcb->BCHType = (tmp & BCH_FLASHLAYOUT0_GF13_0_GF14_1) >> BCH_FLASHLAYOUT0_GF13_0_GF14_1_OFFSET;     // GF13/GF14 
...
static int do_imxkobs(cmd_tbl_t *cmdtp, int flag, int argc, char * const argv[])
{
    loff_t off;
    ulong fw_addr;
    ulong fw_size;
